...
import { getMarkSVG, PrwtMark } from "./prwt-mark";
import { getWordmarkSVG } from "./prwt-wordmark";
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="min-h-80">
          ...
          <CommandGroup heading="Brand Assets">
            ...
            <CommandItem onSelect={() => handleOpenLink("/blog/prwt-brand")}>
              <TriangleDashedIcon />
              Brand Guidelines
            </CommandItem>

            <CommandItem asChild>
              <a href="/assets/prwt-brand.zip" download>
                <DownloadIcon />
  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 border-t bg-zinc-100/30 px-4 text-xs font-medium dark:bg-zinc-800/30">
        <PrwtMark className="size-6 text-muted-foreground" aria-hidden />
